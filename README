...
I am using this repo to collect all of the different variants and colourscheme files for the Zenburn theme I can find, and organise them centrallly. I'm using it as a way to figure out how fork and pull requests work in GitHub too.
...
Most of the following are traced from the comments on the original article. I may have named some of these wrongly, let me know... 
  ...
  - http://echonull.colinta.com/null/you-probably-googled-zenburn-textmate/	TextMate - alternative theme
